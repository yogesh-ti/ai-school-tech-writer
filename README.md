Based on the code changes and commit messages in the GitHub pull request, here are the updates that should be made to the README file:
...
Please ensure to update the README file with the provided changes to reflect the latest updates made to the project based on the recent code changes and commit messages.